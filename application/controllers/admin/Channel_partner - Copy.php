...
Class Channel_partner extends CI_Controller
{
    ...
    function __Construct(){
        ...
        $this->load->model(array('admin/Channelpartner_model','admin/Profile_model','admin/Dashboard_model'));
    ...
    function index(){
        ...
        $data['footer'] = $this->load->view('admin/templates/admin_footer', '', true);
        $data['cp_wallet_value']=$this->Channelpartner_model->get_cpwallet_value();

         $data['details']=$this->Dashboard_model->get_graph_datas();

         $data['activity']=$this->Channelpartner_model->get_recent_activity();
    ...
    function partner_type(){
        $data=$this->set_menu();
        $data['category']=$this->Channelpartner_model->get_category();
     ...
     function new_partner(){
        ...
        if($this->input->is_ajax_request()){
            ...
            //var_dump($tmp);exit();
                ...
                $result=$this->Channelpartner_model->add_partner($password);
                $channelpsw = array();
                if($result){
