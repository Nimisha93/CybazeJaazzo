...
Class Executives_model extends CI_Model{
    ...
    function edit_execbasics($data,$data1,$data3)
    {
        $this->db->trans_begin();
        ...
        $qry2 = $this->db->update('gp_login_table', $data3);
    ...
    function get_executives(){
        $qry="select gp_login_table.*, gp_pl_sales_team_members.*,gp_pl_sales_team_member_details.*,gp_pl_sales_designation_type.designation from gp_pl_sales_team_members
