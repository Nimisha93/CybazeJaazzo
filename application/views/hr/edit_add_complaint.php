      ...
      <div class="">
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>New Complaint<small></small></h2>
              ...
              <div class="x_content">
                <div class="">
                  ...
                  <form action="<?php echo base_url(); ?>hr/complaint/add_complaint" method="post" id="complaint_form" enctype="multipart/form-data">
                    <div class="row">        
                ...
                jQuery(datas).ajaxSubmit({
                    ...
                    success  :    function(data)
                    {
                        if(data.status)
                        {
                            ...
                            var center = '<div id="notifications-full"><div id="notifications-full-close" class="close"><span class="iconb" data-icon="&#xe20e;"></span></div><div id="notifications-full-icon"><span class="icon-thumbs-up" data-icon="&#xe261;"></span></div><div id="notifications-full-text">New Complaint added Succesfully</div></div>';
                    var effect='zoomIn';
