    ...
    <div class="">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <!--   <?php
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" ><i class="fa fa-cog"></i><span class="mnulist">Branch</span></a>
                    <ul class="dropdown-menu accntsubmnuhide">
                        <h4>Branch</h4>

                        <li><a href="<?php echo base_url() ?>branch_list">View Branch</a></li>
                        <li><a href="<?php echo base_url() ?>add_branch">Add Branch</a></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" ><i class="fa fa-sitemap"></i><span class="mnulist">Departments</span></a>
                    <ul class="dropdown-menu accntsubmnuhide">
                        <h4>Departments</h4>
                        <li><a href="<?php echo base_url() ?>add_department"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Departments</a></li>
                        <li><a href="<?php echo base_url();?>designations"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Designation</a></li>
                       

                    </ul>  
                </li> 
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" ><i class="fa fa-users"></i><span class="mnulist">Employees</span></a>
                    <ul class="dropdown-menu accntsubmnuhide">
                        <h4>Departments</h4>
                        <li><a href="<?php echo base_url() ?>employee"><i class="fa fa-id-badge" style="margin-right:6px;"></i>ALL Employees</a></li>
                        <li><a href="<?php echo base_url();?>active_employees"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Active Employees</a></li>
                       

                    </ul>  
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" ><i class="fa fa-money"></i><span class="mnulist">Payroll</span></a>
                    <ul class="dropdown-menu accntsubmnuhide">
                        <h4>Payroll</h4>
                        <li><a href="<?php echo base_url() ?>payments"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Pay Salary</a></li>
                        <li><a href="<?php echo base_url();?>salary_list"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Salary  Payslip</a></li>
                         <li><a href="<?php echo base_url();?>paid_salary_list"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Paid Salary Payslip</a></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" ><i class="fa fa-user-plus"></i><span class="mnulist">Recruitment</span></a>
                    <ul class="dropdown-menu accntsubmnuhide">
                        <h4>Payroll</h4>
                        <li><a href="<?php echo base_url() ?>requisitions"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Requisitions</a></li>
                        <li><a href="<?php echo base_url();?>posts"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Job Posts</a></li>
                         <li><a href="<?php echo base_url();?>candidates"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Candidates</a></li>
                          <li><a href="<?php echo base_url();?>shortlists"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Shortlists</a></li>
                           <li><a href="<?php echo base_url();?>selected"><i class="fa fa-id-badge" style="margin-right:6px;"></i>Selected</a></li>
