      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2 id="tittle">Complaints<small></small></h2>
                <ul class="nav navbar-right panel_toolbox">
                <li>

                       <a href="<?php echo base_url();?>new_complaint" data-original-title="Add new" class="btn btn-success" style="background-color:#162b52"><i class="fa fa-user-plus"></i></a>
                    </li>
                   <li>
              ...
              <div class="x_content">
                <div class="tbleovrscroll">
                  <table id="mytable"  class="display table-bordered table-striped" cellspacing="0" width="100%">
                    ...
                    <tbody>
                     <?php foreach($complaint as $key=> $com) { 

$com_date=$com['created_on'];
$c_date=convert_ui_date($com_date);
                      ?>
                      <tr>
                        <td><?php echo $key+1; ?>
                          <input type="hidden" class="des_id" value="<?php echo $com['id']; ?>"></td>
                        
                        <td><?php echo $com['title']; ?></td>
                        <td><?php echo $com['employee']; ?></td>
                        <td><?php echo $c_date ; ?></td>
                        <td><?php echo $com['description']; ?></td>
                        <td><?php echo $com['emp_status']; ?></td>
                       <td>
                         <a type="button" href="<?php echo base_url();?>update_complaint/<?php echo $com['id']; ?>" class="btn btn-primary fllft edit_btn"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                         
                          <input type="checkbox" name="" value="<?php echo $com['id'];?>" class="chck_grp_item"></td>
    ...
    var table = $('#example').DataTable( {
       ...
       $(document).on('click','.del_btn',function(){
            ...
            if(itemgrps.length > 0){
                ...
                rCallback: function(){
                    $('.body_blur').show();
                            $.post('<?php echo base_url();?>hr/Complaint/deletecomplaint/',{itemgrps:itemgrps}, function(data){
                                $('.body_blur').hide();
                if(data.status)
                {
