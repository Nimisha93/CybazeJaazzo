            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    ...
                    function load_demo(index) {
                        ...
                        $.post(base_url + "view_deal/" + index, { ajax: true,search:search}, function(data) {
                            console.log(data);
                            $('tbody').html("");
                            $('.body_blur').hide();
                            var tr = '';
                    ...
                    '<input type="hidden" value="'+data1[i].id+'" class="hiddentype_id">'+
                                      ...
                                      '<td>'+data1[i].title+'</td>'+
                                        ...
                                        '<td><a href="<?php echo base_url();?>admin/deal/get_deal_byid/'+data1[i].id+'" class="btn btn-simple btn-info btn-icon edit"><i class="material-icons">edit</i><div class="ripple-container"></div></a><a href="#" class="btn btn-simple btn-danger btn-icon remove"><i class="material-icons">close</i></a></td>'+
                                        '</tr>';
                                }
                                $('tbody').html(tr);
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.remove', function(e) {
            ...
            $.post('<?php echo base_url();?>admin/Channel_partner/delete_productbyid/'+hiddentypeid, function(data){
                $('.body_blur').hide();
                if(data.status){
                    var center = '<div id="notifications-full"><div id="notifications-full-close" class="close"><span class="iconb" data-icon="&#xe20e;"></span></div><div id="notifications-full-icon"><span class="icon-thumbs-up" data-icon="&#xe261;"></span></div><div id="notifications-full-text">Successfully deleted deal </div></div>';
                            var effect='zoomIn';
