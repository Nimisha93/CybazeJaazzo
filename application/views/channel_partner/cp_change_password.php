            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form name="password_form" id="password_form" action="<?php echo base_url(); ?>admin/channel_partner/update_password" class="form-horizontal Calendar" method="post" id="user_form">
                            <div class="">

                                <div class="col-md-4">
                                    <div class="form-group label-floating is-empty">
                                        <label class="control-label">Old Password</label>
                                        <input type="password" name="current_password" class="form-control" data-rule-required="true">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group label-floating is-empty">
                                        ...
                                        <input type="password" name="new_password" class="form-control" data-rule-required="true">
                                        <span class="material-input"></span><span class="material-input"></span></div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group label-floating is-empty">
                                        ...
                                        <input type="password" name="confirm_password" class="form-control" data-rule-required="true">
                                        <span class="material-input"></span><span class="material-input"></span></div>
