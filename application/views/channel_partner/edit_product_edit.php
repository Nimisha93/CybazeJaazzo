    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-content">
                 ...
                 <form method="post" action="<?php echo base_url();?>admin/Channel_partner/edit_product_byid/<?= $products['produ']['id'];?>" name="product_form" id="product_form" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                     <div class="form-group label-floating is-empty" style="margin-top: -15px">
                        ...
                        <select name="reward_category" class="form-control reward_category" id="reward_category" data-rule-required="true">
                            ...
                            <option <?= ($ct['id'] == $products['produ']['reward_cat_id'])? "selected": ""; ?> value="<?php echo $ct['id'];?>"><?php echo $ct['category_title'];?> (<?= $ct['percentage']; ?>%)</option>
                            <?php } ?> 
                        </select>
                       </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
         var v = jQuery("#product_form").validate({
                    ...
                    jQuery(datas).ajaxSubmit({
                        ...
                        success  :    function(data)
                        {
                            ...
                            if(data.status)
                            {
                                ...
                                var center = '<div id="notifications-full"><div id="notifications-full-close" class="close"><span class="iconb" data-icon="&#xe20e;"></span></div><div id="notifications-full-icon"><span class="icon-thumbs-up" data-icon="&#xe261;"></span></div><div id="notifications-full-text">Successfully updated product</div></div>';
                                var effect='zoomIn';
...
if(m.form())
{
 ...
 $.each(other_data,function(key,input){
       ...
       // $('#land_reg_btn').prop('disabled', true);

        //  iData.push({name: 'files[]', index: upload_doc});
        // console.log(iData);
