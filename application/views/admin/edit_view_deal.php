...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Active Deals<small></small></h2>
                ...
                <div class="x_content">
                    <div class="">
                        <table id="example" class="display table table-bordered" cellspacing="0" width="100%">
                            ...
                            <?php foreach($products['produ'] as $key => $produ){?>
                            <tr>
                                ...
                                <td class="descrip"><?php echo $produ['special_prize'];?></td>
                                <td><a href="<?php echo base_url();?>admin/Deal/get_deal_byid/<?php echo $produ['id'];?>"><button type="button" class="btn btn-primary type_sub">Edit </button></a>
                                    <button type="button" class="btn btn-danger type_delete1">Delete </button></td>
                                        ...
                                        noty({
                                            ...
                                            buttons: [
                                                {addClass: 'btn btn-primary', text: 'Ok', onClick: function($noty) {
                                                    ...
                                                    $noty.close();
                                                    $('.body_blur').show();
                                                    $.post('<?php echo base_url();?>admin/Deal/delete_dealbyid/'+hiddentypeid, function(data){
                                                        $('.body_blur').hide();
                                                        if(data.status){
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Inactive Deals<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a> </li>
                    </ul>
                    <div class="clearfix"></div>
                ...
                <div class="x_content">
                    <div class="">
                        <table id="example" class="display" cellspacing="0" width="100%">
                            ...
                            <tbody style=" height:100px;overflow:scroll">
                            <?php foreach($products['na_deal'] as $key => $produ){?>
                            <tr>
                                <td class="titleclass"><input type="hidden" value="<?php echo $produ['id'];?>" class="hiddentype_id">
                                    <?php echo $produ['title'];?></td>
                                <td class="descrip"><?php echo $produ['name'];?></td>
                            ...
                            <script>
                                $(document).ready(function(){
                                    ...
                                    $(document).on('click','.type_delete1',function(){
                                        var cur=$(this);
                                        var hiddentypeid=cur.parent().parent().find('.hiddentype_id').val();
                                        //alert(hiddentypeid);
