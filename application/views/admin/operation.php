          ...
          <div class="">
            ...
            <div class="page-title">
              <div class="title_left">
                    <div type="button" class="btn" data-toggle="popover" data-placement="right" title="" data-content="This is the name that will be shown on invoices, bills created for this contact."><i class="fa fa-info-circle" aria-hidden="true"></i></div></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="oprtn">
					...
					<div class="row">
                      ...
                      <div class="animated flipInY fulwdth">
                      <a class="" href="">
                        <div class="accbg1">
                         <div class="accbg1-imagebig">
                        <div class="accbg1-image">
                        
                        <i class="fa fa-cart-arrow-down accfnt" aria-hidden="true"></i>
                        </div></div>
                      ...
                      <a class="" href="">
                        <div class="accbg1">
                         <div class="accbg1-imagebig">
                        <div class="accbg1-image">
                        <i class="fa fa-thumbs-o-up accfnt" aria-hidden="true"></i>
                      ...
                      <a class="" href="">
                        <div class="accbg1">
                         <div class="accbg1-imagebig">
                        <div class="accbg1-image">
                        <i class="fa fa-user-plus accfnt" aria-hidden="true"></i>
                      ...
                      <a class="" href="">
                        ...
                        <i class="fa fa-fighter-jet accfnt" aria-hidden="true"></i>
                        </div></div>
                      ...
                      <a class="" href="">
                        <div class="accbg1">
                         <div class="accbg1-imagebig">
                        <div class="accbg1-image">
                        <i class="fa fa-google-wallet accfnt" aria-hidden="true"></i>
                      ...
                      <a class="" href="">
                        <div class="accbg1">
                         <div class="accbg1-imagebig">
                        <div class="accbg1-image">
                        <i class="fa fa-address-card-o accfnt" aria-hidden="true"></i>
