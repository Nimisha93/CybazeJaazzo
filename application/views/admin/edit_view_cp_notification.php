                    ...
                    <div class="x_content">
                        <div class="">
                            <table id="example" class="display" cellspacing="0" width="100%">
                                ...
                                <?php foreach($notification['cus'] as $noti){?>
                                <tr>
                                    <td class="titleclass"><?php echo $noti['name'];?></td>
                                    <td class="descrip"><?php echo $noti['email'];?></td>
                                    <td class="descrip"><?php echo $noti['notification'];?></td>
                                    <td class="descrip"><?php echo $noti['notification_date'];?></td>
                                </tr>
                                    <?php }?>
                                <script>
