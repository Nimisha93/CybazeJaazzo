                    ...
                    <div class="x_content">
                        <div class="">
                            <div class="table-responsive tabmargntp30">
                                <form method="post" action="<?php echo base_url();?>admin/Deal/new_deal_settings" name="product_form" id="product_form" enctype="multipart/form-data">
                                    <div class="col-md-12">

                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Name</label>
                                            <input type="text" placeholder="Name" name="pro_name" class="form-control validate[required]" value="<?php echo $deal['dl'][0]['name'] ?>">
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Amount</label>
                                            <input type="text" placeholder="Amount" name="amount" class="form-control validate[required]" value="<?php echo $deal['dl'][0]['amount'] ?>">
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Description</label>
                                            <input type="text" placeholder="Description" name="pro_description" class="form-control validate[required]" value="<?php echo $deal['dl'][0]['description'] ?>">
                                        </div>
