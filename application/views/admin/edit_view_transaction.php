                    ...
                    <div class="x_content">
                        <div class="">
                            <table id="example" class="display" cellspacing="0" width="100%">
                                ...
                                <?php foreach($cp_details['details'] as $cpdetai){?>
                                <tr>
                                    <td class="walletid"><input type="hidden" value="<?php echo $cpdetai['waletid'];?>" class="wallet_hiddenid">
                                    <input type="hidden" value="<?php echo $cpdetai['cpid'];?>" class="cp_hiddenid">
                                        <?php echo $cpdetai['name'];?></td>
                                    <td class="total_amount"><?php echo $cpdetai['total_value'];?></td>
                                    <td>
                                        <button type="button" class="btn btn-primary paid_trans"  data-toggle="modal" data-target="#transaction_pop">Paid </button>
                                        <a href="<?php echo base_url();?>admin/Cp_transaction/get_cp_transaction/<?php echo $cpdetai['cpid'];?>"> <button type="button" class="btn btn-danger">View Details </button></td></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                                        ...
                                        <form method="post" id="wal_amountsub" class="wal_amountsub" name="wal_amountsub">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <label>Amount</label>
                                                ...
                                                <input type="text" placeholder="Amount" class="form-control validate[required]" id="pay_amt" name="pay_amt" >
                                                    </div>
                                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                <input type="date" placeholder="Transaction Date" class="form-control validate[required]" id="transaction_date" name="transaction_date" >
                                                </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary amountsub" id="amountsub">Submit</button>
                                </div>
                                </form>
                            </div>
                            <script type="text/javascript">
                                $(document).ready(function(){
                                    $('#amountsub').click(function(e){
                                        e.preventDefault();
                                        var sta = $("#wal_amountsub").validationEngine("validate");
                                        if(sta== true){

                                            var cur= $(this);
                                            var data=$("#wal_amountsub").serializeArray();
                                            $('.body_blur').show();

                                            $.post('<?php echo base_url();?>admin/Cp_transaction/new_transaction', data, function(data){
                                                $('.body_blur').hide();
