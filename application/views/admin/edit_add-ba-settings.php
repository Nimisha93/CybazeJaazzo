...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Business Associate<small></small></h2>
                ...
                <div class="x_content">
                    <div class="">
                        <div class="table-responsive tabmargntp30">
                            <form method="post"  name="product_forms" action="<?php echo base_url();?>admin/Executives/new_ba" id="product_forms" enctype="multipart/form-data">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Name</label>
                                        <input type="text" placeholder="Name" id="ba_name" name="ba_name" class="form-control validate[required]">
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Mobile No</label>
                                        <input type="text" placeholder="Mobile" id="ba_mobile" name="ba_mobile" class="form-control validate[required]">
                                    </div>

                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Email ID</label>
                                        <input type="text" placeholder="Email" id="ba_email" name="ba_email" class="form-control validate[required]">
                                    </div>

                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Company Name</label>
                                        <input type="text" placeholder="Company Name" id="ba_company_Name" name="ba_company_Name" class="form-control validate[required]">
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Office Phone</label>
                                        <input type="text" placeholder="Office Phone" id="office_phone" name="office_phone" class="form-control validate[required]">
                                    </div>


                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Office Email Id</label>
                                        <input type="text" placeholder="Office Email Id" id="office_email_id" name="office_email_id" class="form-control validate[required]">
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>company Location</label>
                                        <input type="text" placeholder="Company Location" name="company_location" id="company_location" class="form-control validate[required]">
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>City /Twon</label>
                                        <input type="text" placeholder="City" id="city" name="city" class="form-control validate[required]">
                                    </div>
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                        <label>Latitude*</label>
                                        <input type="text" placeholder="Latitude" id="lat" name="lat" class="form-control validate[required]">
                                    </div>
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
