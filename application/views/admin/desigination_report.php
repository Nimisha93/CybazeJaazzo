    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Desigination Report<small></small></h2>
                        ...
                        <div class="">
                            ...
                            <table id="purchase_table" class="table table-bordered table-striped">
                                ...
                                <tr class="filters">
                                 ...
                                 <tr class="filters">
                                    <th></th>
                                    <th class="input-filter">Designation</th>
                                    <th class="input-filter">Description</th>
                                    <th class="input-filter">Sort_Order</th>
                                ...
                                <tbody>
                                <?php  foreach ($reports as $key => $vechiles) { ?>
                                <tr>
                                    <td><?= $key+1;?></td>
                                    ...
                                    <td>
                                      ...
                                      <td><?= $vechiles['sort_order'];?></td>
                                      <td><?= $vechiles['status'];?></td>
