    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Reffered Channel Partners<small></small></h2>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function load_demo(index) {
            ...
            $.post(base_url + "get_reffered_cp/" + index, { ajax: true,search:search}, function(data) {
                ...
                if(data.data.length>0){
                    ...
                    for(var i = 0; i< data1.length; i++){
                        ...
                        tr += '<tr>'+
                            ...
                            '<td><a href="'+base_url+"admin/Home/add_reffered_cp/"+data1[i].cp_id+'"><button type="button" class="btn btn-primary type_sub"><i class="fa fa-pencil"></i> </button></a><input type="checkbox" name="" value="'+data1[i].cp_id+'" class="chck_item_id"></td>'+
                            '</tr>';
