                    ...
                    <div class="x_content">
                        <div class="">
                            <div class="table-responsive tabmargntp30">
                                <form method="post" action="" name="payment_ba_form" id="payment_ba_form">
                                    <div class="col-md-12">
                                     ...
                                     <?php   } ?>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <button type="submit" class="btn btn-primary payment_sub_ba" name="payment_sub_ba" id="payment_sub_ba">Save</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
