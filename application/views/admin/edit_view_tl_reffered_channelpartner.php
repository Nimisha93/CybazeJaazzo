    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Reffered Channel Partners - Team Lead Club<small></small></h2>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function load_demo(index) {
            ...
            $.post(base_url + "get_tl_reffered_cp/" + index, { ajax: true,search:search}, function(data) {
                    ...
                    for(var i = 0; i< data1.length; i++){
                        ...
                        tr += '<tr>'+
                            ...
                            '<td>'+data1[i].owner_mobile+'</td>'+
                             ...
                             '<td><a title="Add Channel Partner" href="'+base_url+"admin/Home/add_reffered_cp/"+data1[i].cp_id+'"><button type="button" class="btn btn-primary type_sub"><i class="fa fa-plus"></i> </button></a><input type="checkbox" name="" value="'+data1[i].cp_id+'" class="chck_item_id"></td>'+
                            '</tr>';
