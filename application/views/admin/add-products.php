      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Add New Products<small></small></h2>
              ...
              <div class="x_content">
                ...
                <option value="press">Dr.</option>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        ...
                        <input  type="radio" name="group1" value="Milk"><span class="spacright"> Milk</span>
                        <input type="radio" name="group1" value="Butter"><span class="spacright"> Butter</span>
                         <input type="radio" name="group1" value="Cheese"> <span class="spacright"> Cheese</span>
                          </div>
