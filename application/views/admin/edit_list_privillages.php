            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    ...
                    function load_demo(index) {
                        ...
                        $.post(base_url + "privilleges/" + index, { ajax: true,search:search}, function(data) {
                            console.log(data);
                            $('tbody').html("");
                            $('.body_blur').hide();
                            var tr = '';
                            if(data.status){
                                ...
                                for(var i = 0; i< data1.length; i++){
                                    ...
                                    tr += '<tr>'+
                                        '<td>'+sl_no+'</td>'+
                                        '<td>'+data1[i].title+'</td>'+
                                        '<td>'+data1[i].privileges+'</td>'+
                                        '<td><a href="'+base_url+"admin/Privilleges/edit_privilage_by_id/"+data1[i].id+'"><button type="button" class="btn btn-primary"><i class="fa fa-pencil"></i> </button></a><input type="checkbox" name="" value="'+data1[i].id+'" class="chck_item_id"></td>'+
                                        '</tr>';
                                }
                                $('tbody').html(tr);
