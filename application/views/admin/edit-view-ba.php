...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Business Associate View<small></small></h2>
                ...
                <div class="">
                    <table id="example" class="display" cellspacing="0" width="100%">
                        ...
                        <tr class="tablbg">
                            ...
                            <th>company Name/organisation       </th>
                            <th>Office Phonne No                </th>
                            <th>Office Eamil Id                 </th>
                            <th>Comany Loaction                 </th>
                            <th>Latitude</th>
                            <th>Longitude</th>
                        ...
                        <?php  foreach($viewba as $key =>  $viewba){?>

                        <tr>

                            <td class="titleclass"><input type="hidden" value="<?php echo $viewba['id'];?>" class="hiddentype_id"><?= $key+1;?></td></td>

                            <!--                 <td class="descrip">--><?php //echo $type['username'];?><!--</td>-->

                            <!--    <td class="descrip">--><?php //echo $viewba['password'];?><!--</td> -->

                            <td class="descrip"><?php echo $viewba['name'];?></td>

                            <td class="descrip"><?php echo $viewba['mobil_no'];?></td>

                            <td class="descrip"><?php echo $viewba['email'];?></td>

                            <td class="descrip"><?php echo $viewba['company_name'];?></td>

                            <td class="descrip"><?php echo $viewba['office_phno'];?></td>

                            <td class="descrip"><?php echo $viewba['office_email'];?></td>

                            <td class="descrip"><?php echo $viewba['company_location'];?></td>

                            <td class="descrip"><?php echo $viewba['lat'];?></td>

                            <td class="descrip"><?php echo $viewba['lon'];?></td>




                            <td class="descrip"><?php echo $viewba['county_name'];?></td>
                            <td class="descrip"><?php echo $viewba['state_name'];?></td>
                            <td class="descrip"><?php echo $viewba['city'];?></td>





                            <td><a href="<?php echo base_url();?>admin/Executives/get_ba_view_byid/<?php echo $viewba['id'];?>"><button type="button" class="btn btn-primary type_sub ">Edit </button></a>
                            ...
                            $(document).ready(function(){
                                ...
                                $("#editsub").click(function(e){
                                    ...
                                    if(str==true){
                                        ...
                                        $('.body_blur').show();
                                        $.post("<?php echo base_url();?>admin/Executives/edit_partnertype_byid", data, function(data){
                                            $('.body_blur').hide();
                                            if(data.status){
                                                $('.body_blur').hide();
                                    ...
                                    noty({
                                        ...
                                        buttons: [
                                            {addClass: 'btn btn-primary', text: 'Ok', onClick: function($noty) {
                                                ...
                                                $noty.close();
                                                $('.body_blur').show();
                                                $.post('<?php echo base_url();?>admin/Executives/delete_ba_by_id/'+hiddentypeid, function(data){
