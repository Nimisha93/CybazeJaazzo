                    ...
                    <div class="x_content">
                        <div class="">
                            <div class="table-responsive tabmargntp30">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <button type="button" id="add_group_pooling" class="btn btn-primary antosubmit">Add System Group Pool</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
//            alert(level);
        ...
        $("#add_pool").click(function(e)
        {
            ...
            $.post('<?= base_url(); ?>/admin/pooling/add_new_pool_data',data,function(data)
            {
                if(data.status)
                {
                    noty({text:"Successfully createds",type: 'success',layout: 'top'});
                    $("#new_pool").reset();
        ...
        $("#add_group_pooling").click(function(e)
        {

            window.location="<?php echo base_url(); ?>new_group_pool"
        ...
        $("#add_stage_pooling").click(function(e)
        {
            ...
            window.location="<?php echo base_url(); ?>new_stage_pool"
