                ...
                if(data.status){
                    ...
                    for(var i = 0; i< data1.length; i++){
                        ...
                        tr += '<tr>'+
                            ...
                            '<td>'+ba+'</td>'+
                            '<td>'+bde+'</td>'+
                            '<td>'+form+'<a href="'+base_url+'edit_club_type/'+data1[i].id+'" data-id="'+data1[i].id+'" class="clbtn"><button type="button" class="btn btn-primary type_sub"><i class="fa fa-pencil"></i> </button></a><input type="checkbox" name="" value="'+data1[i].id+'" class="chck_item_id"></td>'+
                            '</tr>';
                    }
                    $('tbody').html(tr);
...
<script>
    ...
    $(document).on('click','.del_btn',function(){
        var cur=$(this);
        var chck_item_id = [];
        var tit='Are You Sure?'+'<br>'+'<p style="font-size: 18px;font-weight: normal;    padding: 20px;">If  you delete this plan,it will affect all the club members,who are in this plan at present .</p>';
