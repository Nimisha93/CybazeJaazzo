    ...
    <div class="clearfix"></div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Channel Partner Report -By Executives<small></small></h2>
            ...
            <div id="report_left_inner" class="report_left_inner" style="display: none">
                <table id="purchase_table" class="table table-bordered table-striped" width="100%">
                    <thead>
                        <tr class="filters">
                            <th colspan="8">JAAZZO<br><p>Channel Partner Report -By Executives</p></th>
                        </tr>
                        <tr class="filters">
                            <th>SI No.</th>
                            <th>Name</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function load_demo(index) {
            ...
            $.post(base_url + "exe_channelpartners/" + index, { ajax: true,search:search}, function(data) {
                console.log(data);
                $('tbody').html("");
                $('.body_blur').hide();
                if(data.status){
                    ...
                    // pagination
                    $('#pagination').html(data.pagination);$('.btn_print').show();
    ...
    $(document).on('click','.btn_print',function(){
        ...
        $.post(base_url + "admin/Report/print_exe_channelpartners_report", {search:search}, function(data) {
            if(data.status){
