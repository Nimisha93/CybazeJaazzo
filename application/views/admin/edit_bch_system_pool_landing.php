...
<script type="text/javascript">
    $(document).ready(function(){
        //get ba pooling
        $.post("<?php echo base_url(); ?>/admin/pooling/get_bch_commision",function(data)
        {
        ...
        $("#ba_persantage").keyup(function()
        {
            ...
            $.post('<?php echo base_url(); ?>admin/pooling/add_bch_commision',{comission:commision},function(data)
            {
...
//            alert(level);
        ...
        $("#add_pool").click(function(e)
        {
            ...
            $.post('<?= base_url(); ?>/admin/pooling/add_new_bch_pool_data',data,function(data)
            {
                if(data.status)
                {
        ...
        $("#add_ba_group_pooling").click(function(e)
        {
            ...
            window.location="<?php echo base_url(); ?>new_bch_group_pool"
        ...
        $("#add_stage_pooling").click(function(e)
        {
            ...
            window.location="<?php echo base_url(); ?>new_bch_stage_pool"
