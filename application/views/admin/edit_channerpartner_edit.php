                ...
                <div class="x_content">
                    <div class="">
                        <div class="table-responsive tabmargntp30">
                            <form method="post" name="channel_form" id="channel_form">
                                <div class="col-md-12">
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Channel Partner Type</label>
                                        <select id="channel_type" class="form-control search-box-open-up search-box-sel-all" name="channel_type[]" multiple="multiple" onchange="console.log($(this).val())">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Name</label>
                                        <input type="hidden" placeholder="Name" name="hiddenid" id="hiddenid" class="form-control validate[required]" value="<?php echo $partner['partner']['id'];?>">

                                        <input type="text" placeholder="Name" name="name" class="form-control validate[required]" value="<?php echo $partner['partner']['name'];?>">
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Phone</label>
                                        <input type="text" placeholder="Phone" name="phone" class="form-control validate[required]" value="<?php echo $partner['partner']['phone'];?>">
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Phone</label>
                                        <input type="text" placeholder="Phone" name="phone2" class="form-control" value="<?php echo $partner['partner']['phone2'];?>">
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Email</label>
                                        <input type="text" placeholder="Email" name="email" class="form-control validate[required]" value="<?php echo $partner['partner']['email'];?>">
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label>Fax</label>
                                        <input type="text" placeholder="Fax" name="fax" class="form-control validate[required]" value="<?php echo $partner['partner']['fax'];?>">
                                    </div>
                                    <div class="col-md-10 col-sm-12 col-xs-12 form-group">
                                        <label>Description</label>
                                        <textarea class="form-control" title="Address" name="address" rows="3" placeholder="Address" class="form-control validate[required]"><?php echo $partner['partner']['address'];?></textarea>
                                    </div>
    ...
    $(document).ready(function(){
        ...
        $('#channelsubmit').click(function(e){
            ...
            if(sta== true){
                ...
                $.post('<?php echo base_url();?>admin/Channel_partner/edit_partner/'+hiddenid, data, function(data){
                    $('.body_blur').hide();
