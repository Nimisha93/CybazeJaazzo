...
<link rel="stylesheet" href="<?php echo base_url();?>assets/datatables/datatable_daterangepicker.css">
...
$('#wallet_activity_table thead tr.filters th').each(function () {
           var title = $(this).text();
        ...
        var table = $("#wallet_activity_table").DataTable({           
            dom: "rBftlip",
            ...
            "initComplete": function (settings, json) {
                ...
                $('#wallet_activity_table').fadeIn();
            },
                

          
            "footerCallback": function( tfoot, data, start, end, display ) {
                var info = $('#wallet_activity_table').DataTable().page.info();
        ...
        ($("#wallet_activity_table_filter input").removeClass("input-sm"));
    ...
    $("#wallet_activity_table_wrapper thead").on("mousedown", "th", function (event) {
...
<div class="">
  <div class="box-body">
                            ...
                            <?php  } ?>
                            <table id="wallet_activity_table" class="table table-bordered table-striped">
                                <thead>
                                ...
                                <th>Description</th>
                                 ...
                                 <tr class="filters">
                                    <th></th>
                                    <th class="input-filter">Wallet</th>
                                    <th class="input-filter">Value</th>
                                  
                                    <th class="date-filter">Date</th>
                                    <th class="input-filter">Description</th>
                                </tr>

                                </thead>
                                <tbody>
                                <?php  foreach ($wallet_activity as $key => $activity) { ?>
                                <tr>
                                    <td><?= $key+1;?></td>
                                    <td><?= $activity['title_a'] == '' ? $activity['title_b'] : $activity['title_a'];?></td>
