                    ...
                    <div class="x_content">
                        <div class="">
                            <div class="tabmargntp30">
                                <form method="post" action="<?php echo base_url();?>admin/home/deactivate_temporarily" name="cp_form" id="cp_form">
                                    <div class="col-md-12">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <h2>Temporarily Deactivated Channelpartners</h2>
                        <ul class="nav navbar-right panel_toolbox">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function load_demo(index) {
            ...
            $.post(base_url + "temporary_deactivation/" + index, { ajax: true,search:search}, function(data) {
        ...
        $(document).on('click','.activate',function(){
            ...
            if(chck_item_id.length > 0){
                $('body').alertBox({
                    ...
                    rCallback: function(){
                        $('.body_blur').show();
                        $.post('<?php echo base_url();?>admin/Home/activate_cp_temp/',{chck_item_id:chck_item_id}, function(data){
                            $('.body_blur').hide();
                            if(data.status){
