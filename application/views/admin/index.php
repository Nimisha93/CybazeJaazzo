      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>System Commision Settings<small></small></h2>
                  ...
                  <div class="table-responsive tabmargntp30">
                    <div class="col-md-12">
                      <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                        <label>Select Channel Partner type</label>
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        <label>Pooling Commision</label>
                        <input type="text" placeholder="Pooling Commision" class="form-control">
                      </div>
                      <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        <label>Direct Commision</label>
                        <input type="text" placeholder="Direct Commision" class="form-control">
                      </div>
                      <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        <label>TC Commision</label>
                        <input type="text" placeholder="TC Commision" class="form-control">
                      </div>
                      <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        <label>BA Commision</label>
                        <input type="text" placeholder="BA Commision" class="form-control">
                      </div>
                ...
                <div class="">
                  <div class="table-responsive tabmargntp30">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        <label>Product Commision</label>
                        <input type="text" placeholder="Direct Commision" class="form-control">
                      </div>
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <label>Discription</label>
                        <textarea class="form-control" rows="3" placeholder="Discription"></textarea>
                      </div>
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <button type="button" class="btn btn-primary antosubmit">Save</button>
                      </div>
