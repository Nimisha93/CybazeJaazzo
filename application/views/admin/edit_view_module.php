                    ...
                    <div class="x_content">
                        <div class="">
                            <table id="example" class="display" cellspacing="0" width="100%">
                                ...
                                <?php foreach($modules['mod'] as $modul){?>
                                <tr>
                                    <td class="walletid"><input type="hidden" value="<?php echo $modul['modid'];?>" class="hiddentype_id">
<!--                                        <input type="hidden" value="--><?php //echo $modul['module_name'];?><!--" class="cp_hiddenid">-->
                                        <?php echo $modul['module_name'];?></td>
                                    <td class="total_amount">h<?php echo $modul['module_name'];?></td>
                                    <td class="total_amount">c<?php echo $modul['module_name'];?></td>
                                    <td class="total_amount"><?php echo $modul['grpname'];?></td>
                                    <td class="total_amount"><?php echo $modul['email'];?></td>
                                    <td class="total_amount"><i class="fa <?php echo $modul['image'];?>" aria-hidden="true"></i>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-primary mod_delete">Delete </button>
                                        <a href="<?php echo base_url();?>admin/privillage/get_module_byid/<?php echo $modul['modid'];?>"> <button type="button" class="btn btn-danger">Edit</button></td></a>
                            ...
                            <script>
                                $(document).ready(function(){
                                    ...
                                    $(document).on('click','.mod_delete',function(){
                                        var cur=$(this);
                                        ...
                                        noty({
                                            ...
                                            buttons: [
                                                {addClass: 'btn btn-primary', text: 'Ok', onClick: function($noty) {
                                                    ...
                                                    $noty.close();
                                                    $('.body_blur').show();
                                                    $.post('<?php echo base_url();?>admin/privillage/delete_module/'+hiddentypeid, function(data){
                                                        $('.body_blur').hide();
                                                        if(data.status){
