            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="">
                            <div class="box-body">
                                <form  action="<?php echo base_url(); ?>admin/Privilleges/update_prv_members/" method="post" id="privilege_form" name="privilege_form">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden"  name="prv_id" id="prv_id" value="<?php echo $privilage['users']['id'] ; ?>">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <select id="1testSelAll" class="form-control select2 1testSelAll" name="prv_members[]"  multiple>
                                                    ...
                                                    ?>
                                                    <option <?= $selcted;?> value="<?php echo $priv['id'];?>" ><a><?php echo $priv['name']?></a></option>
                ...
                var datas = { 
                  ...
                  success:   function(data){
                    ...
                    if(data.status){
                        ...
                        setTimeout(function(){
                            window.location = "<?php echo base_url();?>view_members/0";
                        }, 1000);
                    }else {
