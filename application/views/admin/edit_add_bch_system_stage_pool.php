...
<script type="text/javascript">
    alert("BCH Pooling Percentage Limit Exceeded");
    window.location="<?php echo base_url(); ?>view_bch_pooling"
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#no_of_levels").keyup(function()
        {
            ...
            var new_row='<div><h2></h2> <h2 style="color:green;  ">You can Split <label id="split" name="split">100%</label> To Any Pool Stage<small></small></h2>';
