    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog pupwidth"> 
          ...
          <div class="modal-content">
            <form action="<?php echo base_url(); ?>admin/Privilleges/add_design_prv_members" method="post" id="privilege_form" name="privilege_form" enctype="multipart/form-data">
...
foreach ($employee['employee'] as $key => $employee) {
    ...
    ?>
<option value="<?php echo $employee['id'] ; ?>"><?php echo $employee['designation'] ; ?></option>
...
$(document).ready(function() {
  ...
  if ($('#prv_memb').select2('val') != null){


    var value=$('#prv_memb').select2('val');
...
<script src="<?php echo base_url() ?>assets/admin/js/select2.full.js"  type="text/javascript"></script>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    ...
                    function load_demo(index) {
                        ...
                        $.post(base_url + "view_designation_members/" + index, { ajax: true,search:search}, function(data) {
                            console.log(data);
                            $('tbody').html("");
                            $('.body_blur').hide();
                            var tr = '';
                            if(data.status){
                                ...
                                // '<input type="hidden" id="emp_id" value="'+data1[i].user_id+'">'
                                        ...
                                        '<td><a href="'+base_url+"admin/Privilleges/edit_desg_member_by_id/"+data1[i].id+'" id="btn_edit"class="btn_edit"  data-group_id="'+data1[i].group_id+'" data-usr_privilege_id="'+data1[i].user_id+'"   data-id="'+data1[i].id+'">'+
            ...
            $('#prv_memb').on('change', function (evt) {
                evt.preventDefault();
