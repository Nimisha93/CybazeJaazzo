                ...
                <div class="x_content">
                    <div class="">
                        <div class="table-responsive tabmargntp30">
                            <form method="post"  name="ba_form" action="<?php echo base_url(); ?>admin/Executives/edit_ba/<?php echo $viewba['id'];?>" id="ba_form" enctype="multipart/form-data">
         ...
         var v = jQuery("#ba_form").validate({
            ...
            submitHandler: function(datas) {
                ...
                jQuery(datas).ajaxSubmit({
                    ...
                    //$('#channel_form').hide();
                    $('.body_blur').hide();
                    var center = '<div id="notifications-full"><div id="notifications-full-close" class="close"><span class="iconb" data-icon="&#xe20e;"></span></div><div id="notifications-full-icon"><span class="icon-thumbs-up" data-icon="&#xe261;"></span></div><div id="notifications-full-text">Successfully added BA partner </div></div>';
                    var effect='zoomIn';
