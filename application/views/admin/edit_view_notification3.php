                                                ...
                                                $.post("<?php echo base_url();?>admin/Channel_partner/purchase_approvel_byotp", data, function(data){
                                                    ...
                                                    if(data.status){
                                                       ...
                                                       for(var i =0; i<data.length; i++)
                                                       {
                                                         ...
                                                         '<label style="float:left;">'+data[i].category_title+'</label>'+
                                                         '<input type="hidden" name="percentage[]" class="form-control" value="'+data[i].percentage+'">'+
                                                        
                                                                                                                 
                                                         
                                                         '<input type="text" placeholder="Enter No of Product" name="product_nos[]" class="col-lg-4">'+
...
<!-- otp form -->
    ...
    <div id="saled_cat_modal" class="modal fade" role="dialog">
  <div class="modal-dialog">
