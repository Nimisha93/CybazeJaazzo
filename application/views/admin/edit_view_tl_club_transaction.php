    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Team Lead Club -Transaction<small></small></h2>
                            ...
                            <div id="transaction_pop" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post" id="wal_amountsub" class="wal_amountsub" name="wal_amountsub" action="<?php echo base_url();?>admin/home/add_cm_transaction">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function load_demo(index) {
            ...
            $.post(base_url + "cm_transaction/" + index, { ajax: true,search:search}, function(data) {
                console.log(data);
                $('tbody').html("");
                $('.body_blur').hide();
                if(data.status){
                    ...
                    for(var i = 0; i< data1.length; i++){
                        ...
                        tr += '<tr>'+
                            ...
                            '<td><a href="'+base_url+"admin/Home/view_cm_transaction/"+data1[i].mem_id+'"><button type="button" class="btn btn-danger type_sub">View Details</button></a><button type="button" class="btn btn-primary paid_trans"  data-toggle="modal" data-target="#transaction_pop">Pay </button></td>'+
                            '</tr>';
