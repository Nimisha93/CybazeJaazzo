                        ...
                        <div class="">
                            <table id="example" class="display" cellspacing="0" width="100%">
                              ...
                              <!--   <tfoot>
                                ...
                                <tr>
                                    <td class="titleclass"><input type="hidden" value="<?=$row->id;?>" class="hiddentype_id">
                                       <?=$row->id;?></td>
                                    ...
                                    <td class="descrip"><?=$row->discription;?></td>
                                    
                                    <td><a href="<?php echo base_url();?>admin/Advertisement/get_ads_byid/<?=$row->id;?>"><button type="button" class="btn btn-primary type_sub">Edit </button></a>
                                    ...
                                    $(document).ready(function(){
                                        ...
                                        $("#editsub").click(function(e){
                                            ...
                                            if(str==true){
                                                ...
                                                $('.body_blur').show();
                                                $.post("<?php echo base_url();?>admin/Advertisement/edit_partnertype_byid", data, function(data){
                                                    $('.body_blur').hide();
                                                    if(data.status){
                                            ...
                                            noty({
                                                ...
                                                buttons: [
                                                    {addClass: 'btn btn-primary', text: 'Ok', onClick: function($noty) {
                                                        ...
                                                        $noty.close();
                                                        $('.body_blur').show();
                                                        $.post('<?php echo base_url();?>admin/Advertisement/delete_advertisement/'+hiddentypeid, function(data){
                                                            $('.body_blur').hide();
                                                            if(data.status){
