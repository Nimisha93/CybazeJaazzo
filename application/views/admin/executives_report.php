...
<div class="x_panel">
<div class="x_title">
    <h2>Executive Report<small></small></h2>
                            ...
                            <table id="purchase_table" class="table table-bordered table-striped">
                                ...
                                <tr class="filters">
                                 ...
                                 <tr class="filters">
                                    ...
                                    <th class="input-filter">Last promotion</th>
                                    <th class="input-filter">Description</th>
                                    <th class="input-filter">Desigination</th>
                                ...
                                <tbody>
                                <?php  foreach ($executives as $key => $vechiles) { ?>
                                <tr>
                                    <td><?= $key+1;?></td>
                                    <td><?= $vechiles['name'];?></td>
                                    <td>
                                        ...
                                        <?= $vechiles['last_promotion_date'];?></td>
                                        <td><?= $vechiles['description']?></td>

                                    <td><?= $vechiles['designation']?></td>
