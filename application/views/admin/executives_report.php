    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Executives Report - Created By &nbsp;&nbsp;&nbsp;<h3 id="byy" style="font-size: large;margin-top: 5px;text-transform: capitalize;"></h3></h2>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-3">
                                            <select id="by" class="form-control by" name="by">
                                                ...
                                                <option value="executive">Team Leader</option>
                                            </select>
                                        </div>
                                </div><br>
                ...
                <div id="report_left_inner" class="report_left_inner" style="display: none">
                    <table id="purchase_table" class="table table-bordered table-striped" width="100%">
                        <thead>
                            <tr class="filters">
                                <th colspan="5">JAAZZO<br><p>Executives Report&nbsp;&nbsp;&nbsp;<h3 id="by1" style="font-size: large;margin-top: 5px;text-transform: capitalize;"></h3></p></th>
                            </tr>
                            <tr class="filters">
                                <th>No</th>
                                <th>Name</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function load_demo(index) {
            ...
            $.post(base_url + "executives/" + index, { ajax: true,search:search,by:by}, function(data) {
                console.log(data);
                $('tbody').html("");
                $('.body_blur').hide();
                if(data.status){
                    ...
                    if(by=='club_member'){
                        var byy = 'Club Member';
                    }else if(by=='executive'){
                        var byy = 'Team Leader';
                    }else if(by=='super_admin'){
                        var byy = 'Jaazzo';
                    }else{
                        var byy = '';
                    }
    ...
    $(document).on('click','.btn_print',function(){
        ...
        $.post(base_url + "admin/Report/print_executive_report", {search:search,by:by}, function(data) {
            if(data.status){
