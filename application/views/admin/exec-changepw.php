                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="">
                            <div class="">
                                <div class="col-md-6">
                                    <form action="<?php echo base_url();?>admin/executives/exec_cpw" class="form-horizontal Calendar" method="post">
                                    <div class="col-md-8 col-sm-6 col-xs-12 form-group">
                                        ...
                                        <input type="text" placeholder="Current Password" name='Desigination' ng-model="designation" id="designation" class="form-control"><br>
                                        
                                        <input type="text" placeholder="New Password" name='Desigination' ng-model="designation" id="designation" class="form-control"><br>
                                        
                                        <input type="text" placeholder="Confirm Password" name='Desigination' ng-model="designation" id="designation" class="form-control"><br>
