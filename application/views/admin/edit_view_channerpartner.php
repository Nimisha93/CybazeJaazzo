                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li><a class="btn btn-primary editsub"  style="background-color:#162b52"  href="<?php echo base_url();?>channel_partner"><i class="fa fa-user-plus"></i></a> </li>
                        ...
                        <div class="">
                            <table id="example" class="display" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="descrip"><?php echo $partner['status'];?></td>
