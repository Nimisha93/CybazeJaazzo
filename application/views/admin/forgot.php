                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="">
                            <div class="">
                                <div class="col-md-6">
                                    <form  class="form-horizontal Calendar" name="pass_form" id="pass_form"  action="<?php echo base_url();?>admin/Forgot_psw/forgot_password" method="post" >
                                    <div class="col-md-8 col-sm-6 col-xs-12 form-group">
                                      
                                        
                                        <input type="text" placeholder="Email" name='email' ng-model="designation" id="email" class="form-control"><br>
