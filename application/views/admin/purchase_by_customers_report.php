    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Purchase Report - By Customers&nbsp;&nbsp;&nbsp;<h3 id="byy" style="font-size: large;margin-top: 5px;text-transform: capitalize;"></h3></h2>
                ...
                <div id="report_left_inner" class="report_left_inner" style="display: none">
                    <table id="purchase_table" class="table table-bordered table-striped" width="100%">
                        <thead>
                            <tr class="filters">
                                <th colspan="7">JAAZZO<br><p>Purchase Report&nbsp;By Customers</p></th>
                            </tr>
                            <tr class="filters">
                                <th>No</th>
                                <th>Name of the Customer</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function load_demo(index) {
            ...
            $.post(base_url + "purchase_by_customers/" + index, { ajax: true,search:search,from:from,to:to}, function(data) {
                console.log(data);
                $('tbody').html("");
                $('.body_blur').hide();
                if(data.status){
    ...
    $(document).on('click','.btn_print',function(){
        ...
        $.post(base_url + "admin/Report/print_purcase_report_bycustomers", {search:search,from:from,to:to}, function(data) {
            if(data.status){
                $('.tbodyy').html("");
                var tr = '';
                    var data1 = data.data;
