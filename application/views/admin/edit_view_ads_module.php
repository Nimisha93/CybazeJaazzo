                        ...
                        <table id="example" class="display" cellspacing="0" width="100%">
                            ...
                            <tr>
                               ...
                               <input type="hidden" value="<?php echo $ads['id'];?>" class="hiddentype_id">
                                ...
                                <td><?= $key+1;?></td>
                                <td class="descrip"><img src="<?php echo base_url();?>assets/admin/model/<?php echo $ads['module_image'];?>" width="50px" height="50px"></td>
                                ...
                                $(document).ready(function(){
                                    ...
                                    $("#editsub").click(function(e){
                                        ...
                                        if(str==true){
                                            ...
                                            $('.body_blur').show();
                                            $.post("<?php echo base_url();?>admin/Product/edit_partnertype_byid", data, function(data){
                                                $('.body_blur').hide();
                                                if(data.status){
                                        ...
                                        noty({
                                            ...
                                            buttons: [
                                                {addClass: 'btn btn-primary', text: 'Ok', onClick: function($noty) {
                                                    ...
                                                    $noty.close();
                                                    $('.body_blur').show();
                                                    $.post('<?php echo base_url();?>admin/product/delete_module_ads/'+hiddentypeid, function(data){
                                                        $('.body_blur').hide();
                                                        if(data.status){
