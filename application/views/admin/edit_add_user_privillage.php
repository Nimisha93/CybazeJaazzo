                                ...
                                <form method="post"  name="priv_form" id="priv_form" enctype="multipart/form-data">
                                    <div class="col-md-12">
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input type="text" placeholder="User Name" name="user_name" id="user_name" class="form-control validate[required] group_name">
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <select id="access_perm" class="form-control validate[required] search-box-open-up search-box-sel-all testSelAll" name="access_perm[]"  multiple="multiple" onchange="console.log($(this).val())">
                                                <?php foreach($access_priv['privi'] as $apriv){?>
                                                <option value="<?php echo $apriv['id'];?>"><?php echo $apriv['privilege'];?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Allow Permission</label>
                                            <select id="allow_perm" class="form-control validate[required] search-box-open-up search-box-sel-all testSelAll" name="allow_perm[]"  multiple="multiple" onchange="console.log($(this).val())">
                                                <?php foreach($allow_priv['privi'] as $alpriv){?>
                                                <option value="<?php echo $alpriv['id'];?>"><?php echo $alpriv['privilege'];?></option>
                                                <?php } ?>
                                            </select>
                                            </select>
                                        </div>
            ...
            $(document).ready(function() {
                ...
                $('#persubmit').click(function(e){
                    ...
                    if(sta== true){
                        ...
                        $.post('<?php echo base_url();?>admin/privillage/new_userpermission_module', data, function(data){
                            $('.body_blur').hide();
