                                ...
                                <form method="post" name="mail_form" id="mail_form" enctype="multipart/form-data">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <select id="cus_mail" class="form-control validate[required] search-box-open-up search-box-sel-all" name="cus_mail[]" multiple="multiple" onchange="console.log($(this).val())">
                                                <?php foreach($customers['cus'] as $mail){?>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <label>Subject</label>
                                            <input type="text" class="form-control" title="Subject" name="subject"  placeholder="Subject" class="form-control validate[required]">
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <label>Message</label>
                                            <textarea class="form-control" title="Message" name="message" rows="3" placeholder="Message" class="form-control validate[required]"></textarea>
                                        </div>

                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <input type="submit" class="btn btn-primary prosubmit" name="mailsub" id="mailsub" value="Send">
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            $(document).ready(function(){
                $('#mailsub').click(function(e){
                    ...
                    if(sta== true){
                        ...
                        $.post('<?php echo base_url();?>admin/Channel_partner/send_new_mail', data, function(data){
                            $('.body_blur').hide();
