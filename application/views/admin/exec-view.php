...
<div class="x_panel">
<div class="x_title">
    <h2>Executives View<small></small></h2>
...
<tr>
    ...
    <!-- <td class="parent"><?php echo $type['parent_id'];?></td> -->
    ...
    <td class="fax"><?php echo $type['fax'];?></td>

    <!-- <td class="stat"><?php echo $type['status'];?></td> -->

    <!--<td class="descrip"><?php echo $type['created_by'];?></td>

    <td class="descrip"><?php echo $type['created_on'];?></td>

    <td class="descrip"><?php echo $type['updated_by'];?></td>

    <td class="descrip"><?php echo $type['updated_on'];?></td> -->
                ...
                <div class="modal-body">
                    <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="col-md-10 col-sm-12 col-xs-12">
                            ...
                            <input type="text" placeholder="Last Name" class="form-control" id="name" name="title">
                        </div>
                        <div class="col-md-10 col-sm-12 col-xs-12">
                                        <label>Designation</label>
                            <!-- <input type="text" placeholder="Last Name" class="form-control" id="desig" name="title"> -->
                                        <select name="dsig" class="form-control">
                        ...
                        <div class="col-md-10 col-sm-12 col-xs-12">
                            <label>E-mail</label>
                            <input type="hidden" placeholder="Last Name" class="form-control" id="hiddentype" name="hiddentype">
                            <input type="text" placeholder="Last Name" class="form-control" id="email" name="title">
                        </div>
                        <div class="col-md-10 col-sm-12 col-xs-12">
                            <label>Mobile</label>
                            <input type="hidden" placeholder="Last Name" class="form-control" id="hiddentype" name="hiddentype">
                            <input type="text" placeholder="Last Name" class="form-control" id="phone" name="title">
                        </div>
                        <div class="col-md-10 col-sm-12 col-xs-12">
                            <label>Address</label>
                           <textarea class="form-control" id="add" name="descriptext"></textarea>
                        </div>
                        <div class="col-md-10 col-sm-12 col-xs-12">
                            <label>Fax</label>
                            <input type="hidden" placeholder="Last Name" class="form-control" id="hiddentype" name="hiddentype">
                            <input type="text" placeholder="Last Name" class="form-control" id="fax" name="title">
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
        $(document).on('click','.type_sub',function(){
            ...
            var email=cur.parent().parent().find('.email').text();
            var desig=cur.parent().parent().find('.desig').text();
            var name=cur.parent().parent().find('.name').text();
            var parent=cur.parent().parent().find('.parent').text();
            var lpd=cur.parent().parent().find('.lpd').text();
            var phone=cur.parent().parent().find('.phone').text();
            var add=cur.parent().parent().find('.add').text();
            var fax=cur.parent().parent().find('.fax').text();
            var stat=cur.parent().parent().find('.stat').text();
            $(document).find('#title').val(title);
            $(document).find('#email').val(email);
            $(document).find('#desig').val(desig);
            $(document).find('#name').val(name);
            $(document).find('#parent').val(Parent);
            $(document).find('#lpd').val(lpd);
            $(document).find('#phone').val(phone);
            $(document).find('#add').val(add);
            $(document).find('#fax').val(fax);
            $(document).find('#stat').val(stat);
