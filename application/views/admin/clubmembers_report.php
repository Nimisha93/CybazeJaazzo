                            ...
                            <table id="purchase_table" class="table table-bordered table-striped">
                                ...
                                <tr class="filters">
                                 ...
                                 <tr class="filters">
                                    ...
                                    <th class="input-filter">Phone2</th>
                                    <th class="input-filter">Pincode</th>
                                    <th class="input-filter">Address</th>
                                    <th class="input-filter">Type</th>
                                     <th class="input-filter">Description</th>
                                      <th class="input-filter">Amount</th>
                                       <th class="input-filter">Cash limit</th>
                                        <th class="input-filter">Pooling commision</th>
                                         <th class="date-filter">Date & time</th>
                                </tr>

                                </thead>
                                <tbody>
                                <?php  foreach ($members as $key => $vechiles) { ?>
                                <tr>
                                    <td><?= $key+1;?></td>
                                    <td><?= $vechiles['name'];?></td>
                                    <td>
                                        ...
                                        <?= $vechiles['phone'];?></td>
                                    <td><?= $vechiles['phone2'];?></td>

                                     <td><?= $vechiles['pincode'];?></td>
                                    <td><?= $vechiles['address'];?></td>
                                    <td><?= $vechiles['title'];?></td>

                                    <td><?= $vechiles['description'];?></td>
