    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>BA Report - Created By &nbsp;&nbsp;&nbsp;<h3 id="byy" style="font-size: large;margin-top: 5px;text-transform: capitalize;"></h3></h2>
                ...
                <div id="report_left_inner" class="report_left_inner" style="display: none">
                    <table id="purchase_table" class="table table-bordered table-striped" width="100%">
                        <thead>
                            <tr class="filters">
                                <th colspan="7">JAAZZO<br><p>BA Report&nbsp;&nbsp;&nbsp;<h3 id="by1" style="font-size: large;margin-top: 5px;text-transform: capitalize;"></h3></p></th>
                            </tr>
                            <tr class="filters">
                                <th>No</th>
                                <th>Name</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function load_demo(index) {
            ...
            $.post(base_url + "ba_report/" + index, { ajax: true,search:search,by:by}, function(data) {
                console.log(data);
                $('tbody').html("");
                $('.body_blur').hide();
                if(data.status){
    ...
    $(document).on('click','.btn_print',function(){
        ...
        $.post(base_url + "admin/Report/print_ba_report", {search:search,by:by}, function(data) {
            if(data.status){
