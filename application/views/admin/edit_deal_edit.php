                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <select id="pro_category" class="form-control validate[required] " name="pro_category">
                                                ...
                                                <option <?= $products['produ']['category_id']==$category['id'] ? 'selected' : ''?> value="<?php echo $category['id'];?>"><?php echo $category['title'];?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input type="text" placeholder="Special Prize" name="special_prize" id="special_prize" class="form-control validate[required]"  value="<?= $products['produ']['special_prize']?>">
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Cost</label>
        ...
        $(document).ready(function() {
            ...
            $('#product_form').ajaxForm({
                ...
                success:   function(data){
                    if(data.status){
                        noty({text: 'Deal Updated', type: 'success', timeout: 1000 });
                        window.location = "<?php echo base_url();?>deal_list";
                    } else {
