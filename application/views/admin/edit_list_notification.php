                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                           <li><a class="btn btn-primary editsub"  style="background-color:#162b52"  href="<?php echo base_url();?>Notifications"><i class="fa fa-user-plus"></i></a> </li>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    ...
                    function load_demo(index) {
                        ...
                        $.post(base_url + "All_notifications/" + index, { ajax: true,search:search}, function(data) {
                            console.log(data);
                            $('tbody').html("");
                            $('.body_blur').hide();
                            var tr = '';
                ...
                $(document).on('click','.del_btn',function(){
                    ...
                    if(chck_item_id.length > 0){
                        $('body').alertBox({
                            ...
                            rCallback: function(){
                                $('.body_blur').show();
                                $.post('<?php echo base_url();?>delete_notification/',{chck_item_id:chck_item_id}, function(data){
                                    $('.body_blur').hide();
                                    if(data.status){
