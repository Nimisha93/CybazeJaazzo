...
<!--                                        <input type="text" placeholder="Allowed Persantage(%)" name="allow_persantage"  value="--><?php //echo $pooling_details[0]['percentage']; ?><!--" class="form-control validate[required]">-->
<!--                                    </div>-->
<!--                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">-->
                    ...
                    <table class="table">
                        <tbody><tr>
                            ...
                            <td style="border:none;">
                                ...
                                <input placeholder="Allowed Persantage(%)" id="allow_persantage" value="<?php echo $pooling_details[0]['percentage']; ?>" name="no_of_levels" class="form-control validate[required]" type="text"></td>
