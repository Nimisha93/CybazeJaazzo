                        ...
                        <div class="">
                            <table id="example" class="display" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?= base_url();  ?>admin/pooling/full_system_pool_settings/<?= $pool_group['id']; ?>/group/">View Full Pool Settings</a>
                                ...
                                <tr>
                                    ...
                                    <td class="descrip"><?php echo $pool_group['group_persentage'];?></td>
                                    <td class="descrip"><?php echo $pool_group['no_of_levels'];?></td>
                                    <td><a href="<?= base_url();  ?>admin/pooling/full_system_pool_settings/<?= $pool_group['id']; ?>/stage/">View Full Pool Settings</a>
                                        ...
                                        noty({
                                            ...
                                            buttons: [
                                                {addClass: 'btn btn-primary', text: 'Ok', onClick: function($noty) {
                                                    ...
                                                    $noty.close();
                                                    $('.body_blur').show();
                                                    $.post('<?php echo base_url();?>admin/Pooling/delete_system_pool_group/'+hiddentypeid, function(data){
                                                        $('.body_blur').hide();
                                                        if(data.status){
                                                            noty({text: 'Deleted Succesfully', type: 'success', timeout:1000});
                                                            cur.parent().parent().remove();
                                        ...
                                        noty({
                                            ...
                                            buttons: [
                                                {addClass: 'btn btn-primary', text: 'Ok', onClick: function($noty) {
                                                    ...
                                                    $noty.close();
                                                    $('.body_blur').show();
                                                    $.post('<?php echo base_url();?>admin/Pooling/delete_system_stage_pool_group/'+hiddentypeid, function(data){
                                                        $('.body_blur').hide();
                                                        if(data.status){
                                                            noty({text: 'Deleted Succesfully', type: 'success', timeout:1000});
                                                            cur.parent().parent().remove();
 ...
 <div class="row">
            ...
            <?php $color = array('warning','primary','success','info');?>
              <?php  foreach($pooling_groups as $key=> $pool_group ){?>
                <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">        
                    ...
                    <input type="hidden" value="<?php echo $pool_group['id'];?>" class="hiddentype_id">
                        ...
                        <div class="price_table_body">
                            <div class="price_table_row cost <?php echo $color[$key];?>-bg"><strong><?php echo $pool_group['group_persentage'];?> </strong><span>%</span></div>
               ...
               <a href="<?= base_url();  ?>admin/pooling/full_system_pool_settings/<?= $pool_group['id']; ?>/group/" class="btn btn-<?php echo $color[$key];?> btn-lg btn-block">View Full Pool Setting</a>
                <a href="#" class="btn btn-<?php echo $color[$key];?> btn-lg btn-block commission_delete">Delete Pool Group</a>
                    </div>
                </div>
          <?php } ?>
           <?php  foreach($pooling_stages as $pool_group ){?>
            <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">        
               ...
               <a href="<?= base_url();  ?>admin/pooling/full_system_pool_settings/<?= $pool_group['id']; ?>/stage/" class="btn btn-warning btn-lg btn-block">View Full Pool Setting</a>
