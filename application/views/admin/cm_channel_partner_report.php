    ...
    <div class="clearfix"></div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Channel Partner Report -By Club Members<small></small></h2>
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control search"  name="search" id="search" placeholder="Type  Keyword">
                                    </div>
            ...
            <div id="report_left_inner" class="report_left_inner" style="display: none">
                <table id="purchase_table" class="table table-bordered table-striped" width="100%">
                    <thead>
                        <tr class="filters">
                            <th colspan="8">JAAZZO<br><p>Channel Partner Report -By Club Members</p></th>
                        </tr>
                        <tr class="filters">
                            <th>SI No.</th>
                            <th>Name</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function load_demo(index) {
            ...
            $.post(base_url + "cm_channelpartners/" + index, { ajax: true,search:search,club_type:club_type}, function(data) {
                console.log(data);
                $('tbody').html("");
                $('.body_blur').hide();
                if(data.status){
                    ...
                    $('#club_type').val(data.club_type);$('.btn_print').show();
    ...
    $(document).on('click','.btn_print',function(){
        ...
        $.post(base_url + "admin/Report/print_cm_channelpartners_report", {search:search,club_type:club_type}, function(data) {
            if(data.status){
                ...
                var tr = '';
                    ...
                    for(var i = 0; i< data1.length; i++){
                        ...
                        tr += '<tr>'+
                            ...
                            '<td>'+data1[i].cm_name+'</td>'+
                            '<td>'+data1[i].cname+'</td>'+
                            '<td><img src='+base_url+data1[i].brand_image+' style="width: 10%;height: auto;"></td>'+
                            '<td>'+data1[i].phone+'</td>'+
                            '<td>'+data1[i].phone2+'</td>'+
                            '<td>'+stat+'</td>'+
                            '</tr>';
