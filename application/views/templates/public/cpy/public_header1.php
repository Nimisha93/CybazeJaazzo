    ...
    function ajaxSearch()
    {
       ...
       if (input_data.length === 0)
        ...
        else
        {
          ...
          <div class="col-md-6 walltbx hidden-xs">
          <?php
           if($session_array != NULL){ ?>
...
<!--                                            <li class="col-sm-3">-->
<!--                                                <ul>-->
<!--                                                    <li class="dropdown-header">Mens Collection</li>-->
<!--                                                    <div id="menCollection" class="carousel slide" data-ride="carousel">-->
<!--                                                        <div class="carousel-inner">-->
<!---->
<!--                                                            --><?php
//                                                             foreach ($product['product'] as $key => $prod){
//                                                            // foreach ($product['module'] as $key => $prods){
...
<!--                                            </li>-->
                                            <ul>
                                                ...
                                                <?php foreach($subcategory['type'] as $stype){
                                                if($stype['parent']==$pid){ ?>
                                                    <li class="col-sm-3"><a class="dropdown-header" href="#"><?php echo $stype['title']; ?></a>
                                                        <ul>
