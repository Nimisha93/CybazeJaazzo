...
<footer class="footr_bgclr1">
    ...
    <div class="clear"></div>
        ...
        <div class="container top_pad30 ">
            ...
            <div class="border3">
                <div class="col-md-5 col-sm-5 wow slideInLeft t30">
...
<!--                                app</label>-->
    ...
    <!--===========container end here ========================-->
     ...
     <div class="container top_pad10 tp_mar20"> </div>
    ...
    <!--===========container end here ========================-->
        <div class="container ">
            ...
            <div class=" bm_mar10">
                <div class="clear"></div>
                <div class="col-md-2 col-sm-2 wow slideInLeft "> </div>
...
<!--===========common js end ========================--> 
 ...
 <script type="text/javascript" src="<?php echo base_url();?>assets/public/custom_js/sociallogin.js"></script>
       ...
       <script type="text/javascript">
        $(document).ready(function(){
            $('#transfer_submits').click(function(e){
                e.preventDefault();
                var sta = $("#transfer_forms").validationEngine("validate");
                if(sta== true){
                    var cur= $(this);
                    var data=$("#transfer_forms").serializeArray();
                    $('.body_blur').show();
                    $.post('<?php echo base_url();?>user/Refer/add', data, function(data){
                        $('.body_blur').hide();
                        if(data.status){
                            noty({text:"Successfully created",type: 'success',layout: 'top', timeout: 3000});
                            $('#transfer_forms')[0].reset();
                           $('#transfer_modals').modal('hide');  
                        }
                        else{
