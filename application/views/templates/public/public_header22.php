            ...
            <div class="su_listnav">
              <ul>
                <div class="fllft_mmbr">
                  <?php
                    // echo encrypt_decrypt('decrypt','NVdBZWdKcDVkL1ZVOENZME92MkRsdz09');
                ...
                <?php } else{ ?>
                            ...
                            <div class="">
                              <div class="logn_frrmbx">
                                <form name="transfer_form" method="post" id="transfer_form" action="<?php echo base_url();?>user/Money_transfer/transfer_amount">
                                  ...
                                  <div class="logn_frrmbx">
                                    Enter Mobile :  <input class="txt_bg3" name="transfer_mobile" type="text" placeholder="Mobile" />
                                    <br>
                                    Enter Amount :  <input class="txt_bg3" name="transfer_amount" type="text" placeholder="Amount" />
                  ...
                  <?php  
                      if($session_array2['type']=='club_member'|| $session_array1['type']=='normal_customer'){ ?>
                                      ...
                                      <!-- <input class="txt_bg3 validate[required]" name="wallet" type="text" value="<?php echo $wallet1['amount']['total_value'];?>" /> -->
                                        <div class="logn_frrmbx">
                                         ...
                                         <!-- <button id = "more" class="btn button_more ">More Details</button>
                                          ...
                                          <input type="submit" name="transfer_submit" id="transfer_submits" class="button_submit3 continue_login" value="continue">
                                        </div>
                                      </form>
                                    </div>
                                  </div>
                        ...
                        <?php }if($session_array2['type']=='club_member'){
                                ...
                                $ca_facility = club_agent_facilty_bycm($lid);
                                if($ca_facility['ca_limit']>$ca_facility['ca_count']){
                        ?>
                        ...
                        <?php   }}else if($session_array3['type']=='club_agent'){ ?>
                ...
                <?php } ?>
                  <div class="fllft_mmbr">
                    <li style="list-style:none;float:left;margin:0px 2px;border:none;text-align:center;padding:4px 10px;background-color:#3c4a7e;"><a href="<?= base_url();?>home/club_membership" style="color:#FFF"><span class="icnspace"> <?php echo isset($session_array2)?'Upgrade':'Be a Club Member ';?></span> </a> </li>
                  </div>
              </ul>
            </div>
          </div>
