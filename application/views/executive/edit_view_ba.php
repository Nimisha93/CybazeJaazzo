...
<tr>
    ...
    <td><?php echo $type['office_phno'];?></td>
    <td><?php echo $type['office_email'];?></td>
    ...
    <td class="text-right">
        ...
        <a href="<?php echo base_url();?>admin/Executives/exec_get_ba_view_byid/<?php echo $type['id'];?>" class="btn btn-simple btn-info btn-icon edit"><i class="material-icons">edit</i></a>
