...
if(empty($data['data'])){
    ...
    ?>
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 category-right" style="margin-left: -147px;">
            ...
            // 
             ...
             var cat_id = "<?php echo $cat_id; ?>";
              ...
              function load_demo1(index) {
                ...
                $('.body_blur').show();
                $.post(base_url + "home/get_all_products_cat_wise/"+cat_id+'/page/' + index, {  ajax: true, sort_order : sort_order, category:categories, brand:brands }, function(data) {
                  ...
                  $('.body_blur').hide();
                    if(data.data.status){
                      ...
                      var div='';
                      div += '<div class="blk tp_mar20"><h3 style="font-size: 21px;line-height: 50px">No Product(s) Found !!!</h3></div>';
                      $('.load_pro').html(div);   
                      $('#pagination').html(data.pagination); 
                    }
                }, "json");
