          ...
          <div class="strchbxchild2">
            ...
            <div class="panel panel-defaul" style="background: none">
              <ul>
                ...
                <?php if(($type=='club_member' && $investor>0)||($type=='club_agent')) { ?>
                <li><i class="fa fa-exchange marleft7" aria-hidden="true" style="color: #fff;"></i>Transactions</li>
                <?php } ?>
              </ul>
              <?php if($type=='club_agent') { ?>
              <div class="t">
                <div class="panel-heading" style="color: #fff">
                 
                  <a data-toggle="collapse" href="#collapse1" style="color: #fff;font-size: 14px;"> <i class="fa fas fa-align-justify marleft7" aria-hidden="true"></i>Statements</a>
                </div>
                <div id="collapse1" class="panel-collapse collapse">
                  <ul class="list-group" style="color: #fff">
                    <li id="history" class="resp-tab-item" aria-controls="tab_item-0" class="list-group-item" style="text-align: center;"><i class="fa fa-wallet marleft7" aria-hidden="true"></i>Rewards Statements</li>
                  </ul>
                </div>
              </div>
              ...
              <div class="t">
                <div class="panel-heading" style="color: #fff">
                  <a data-toggle="collapse" href="#collapse2" style="color: #fff;font-size: 14px;">
                  <i class="fa fa-user marleft7" aria-hidden="true"></i>Statements</a>
                </div>
                <div id="collapse2" class="panel-collapse collapse">
                  <ul class="list-group" style="color: #fff">
                    <?php if($type=='club_agent'||$type=='club_member') { ?>
                    <li id="history2" class="resp-tab-item" aria-controls="tab_item-2" class="list-group-item">Benefit From Members</li>
                    <?php } 
                    if($type=='club_member') { ?> 
                    <li id="history" class="resp-tab-item" aria-controls="tab_item-1" class="list-group-item">Benefit From Channel Partner</li>
                    <li id="history2" class="resp-tab-item" aria-controls="tab_item-2" class="list-group-item">Benefit From Club Agents</li>
                    <?php } ?> 
                  </ul>
                </div>
              </div>
        ...
        <div class="resp-tabs-container">
            ...
            <div class="row wlletbg_prfile">
                ...
                if((($type=='club_member') && (($club_type_id>0 || $investor>0) && $fixed==0)||($club_type_id>0))||$type=='club_agent'){
                  ...
                  if($type=='club_agent'){
                    ...
                    $ul_cp_status =$det1['cp_status'];
                    if($fixed>0){
                      $fixed_details = getClubtypeById($fixed);
          ...
          <div>
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="row wlletbg_prfile">
                  <h1 class="profil_ttlt">
                    Rewards Through Club Agents
                  </h1>
                  <div id="no-more-tables2">
                    <div class="row">
                        <div class="col-sm-3">
                          <select class="form-control" name="search" id="search4">
                            <option value="">Select Any Club Agent</option>
                            <?php foreach($cagents as $ag){ ?>
                        ...
                        <div ng-app="date">
                          <div ng-controller="dateCtrl">
                            ...
                            <div class="col-sm-3">
                              <input type="button" value="Search" name="btn_serh" id="btn_serh" class="btn btn-primary">
                            </div>
                          </div>
                        </div>
                    </div><br>
