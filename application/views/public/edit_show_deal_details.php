    ...
    <div class="bgclr3 border3">
            ...
            <div class="col-md-5 col-sm-5">
                ...
                top: 0px; left: 0px;width: 100%;height:100%;">
                        ...
                        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 400px; height: 450px; overflow: hidden;">
                            ...
                            <div>
                                <img u="image" src="<?php echo base_url();?>assets\admin\products\<?php echo $deals[0]['image'] ?>" />
                                <img u="thumb" src="<?php echo base_url();?>assets\admin\products\<?php echo $deals[0]['image'] ?>" />
                            </div>
                            ...
                            foreach($deals as $deal)
                            {
                                ...
                                ?>
                                <div>
                                    <img u="image" src="<?php echo base_url();?>assets\admin\products\<?php  echo $deal['product_image']; ?>" />
                                    <img u="thumb" src="<?php echo base_url();?>assets\admin\products\<?php  echo $deal['product_image']; ?>" />
                                </div>
                                <?php } ?>
        ...
        <span u="arrowright" class="jssora05r" style="width: 40px; height: 40px; top: 158px; right: 8px">
            ...
            <div class="col-md-7 col-sm-7">
                ...
                <div class="brndname"><?php echo $deals['0']['name'];?> </div>

                <div class="companylogo"><img src="<?php echo base_url();?>assets\admin\brand\<?php echo $deals['0']['brand_image'];?>"></div>
                <div class="companyname"><?php echo $deals['0']['cp_name'];?></div>
                <div class="clear"></div>
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="brnd_spcifctn tp_mar10">
                            ...
                            <tr>
                                ...
                                <td><?php echo $deals[0]['description'];?></td>
                            </tr>
                        ...
                        <div class="ratebox">
                            <table>
                                <tr>
                                    ...
                                    <td class="brand_rate_none"> <span class="rupee">RS</span><?php echo $deals[0]['cost'];?> </td>
                                </tr>


                                <tr>
                                    <td class="brand_rate">Model</td>
                                    <td class="brand_rate_actual"> <span class=""></span><?php echo $deals[0]['model'];?> </td>
                                </tr>


                                <tr>
                                    <td class="brand_rate"> Our Deal</td>
                                    <td class="brand_rate_actual"> <span class="rupee">RS</span><?php  echo $deals[0]['actual_cost'];?> </td>
                                </tr>
            ...
            <div id="more" class="border3 tp_mar50" >
                <div class="col-md-12">
                    ...
                    <table class="brnd_spcifctn_full tp_mar10">
                        ...
                        <tbody>
                        <?php echo $deals[0]['full_specification'];?>
                        </tbody>
                    </table>
