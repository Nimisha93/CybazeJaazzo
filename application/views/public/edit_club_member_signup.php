...
<section class="top_pad20 botm_pad20">
	<div class="container tp_mar20">
		...
		<div class="col-md-offset-2 col-md-6">
			<div class="col-xs-12">
			    <h2 class="tp_mar20">Club Member Set Password</h2>
				<h3>Get Started-it's Free.</h3>
				<h5>Registration take less than 2 minutes</h5>
			</div>
			<div class="cusmragnt">
				<form name="become_club_agent" action="<?php echo base_url(); ?>Home/signup_clubmember" method="post" id="become_club_member">        
