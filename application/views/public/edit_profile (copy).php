          ...
          <div class="strchbxchild2">
            ...
            <?php 
              ...
              $det = get_cm_facility_by_id($lid);
               if(!empty($det['cp_details']) &&$det['cp_limit']>=$det['cp_count']){
            ?>
                    ...
                    <tbody>
                      <?php foreach($refer as $key => $ref){ ?>
                        <tr>
                          ...
                          <td data-title=""><?php echo $ref['location'];?></td>
                          <td data-title="">
                            <button type="button" class="btn addprofiletab"  data-toggle="modal" data-target="#addfrend_dtils_<?php echo $ref['id'];?>"><i class="fa fa-plus-circle" aria-hidden="true"></i> <span class="hidbtn_prfl">Update Details </span></button>
                            <button type="button" class="btn deletprofiletab del_refer_frnd" data-id="<?php echo $ref['id'];?>"><i class="fa fa-trash-o" aria-hidden="true"></i>  <span class="hidbtn_prfl">Delete </span></button>
                          </td>
                        </tr>
                        <div id="addfrend_dtils_<?php echo $ref['id'];?>" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                            <!-- Modal content-->
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-body">
                                <div class="prfl_trnsfr wlletbg_prfile tp_mar20 " style="overflow:hidden">
                                    <div class="form-group">
                                      <label>Name</label>
                                      <input type="text" class="form-control" value="<?php echo $ref['name'];?>" name="name" id="name">
                                      <input type="hidden" name="row_id"  value="<?php echo $ref['id'];?>">
                                    </div>      
                                    <div class="form-group">
                                      <label>Mobile Number</label>
                                      <input type="text"  name="mobile" class="form-control" value="<?php echo $ref['mobile'];?>" id="mobile">
                                    </div> 
                                    <div class="form-group">
                                      <label>Location</label>
                                      <input type="text" class="form-control" placeholder="Enter Your Location" name="location" id="location" value="<?php echo $ref['location'];?>">
                                    </div>
                                </div>
                              </div>
                              <div class="modal-footer">
