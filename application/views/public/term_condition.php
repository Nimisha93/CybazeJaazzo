...
<div class="row content" style="margin-bottom: 50px;margin-top: 50px;">
<!-- ==================================== Mobile menu =====================================-->
            ...
            <div class="">
                <div class="prdctarea">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="ftrd_hding">Terms &amp; Condition</div>
                        <div class="hlpbdrbtm"> <strong>
                            <h3>Eligibility</h3>
                        </strong>
                            ...
                            <p> That the address at which delivery of the product ordered by you is to be made will be correct and proper in all respects. </p>
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
