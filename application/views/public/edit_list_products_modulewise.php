...
<script type="text/javascript">
        $(document).ready(function(){
            ...
            function load_demo(index) {
              ...
              $.post(base_url + "home/get_all_products_module_wise/"+mod_id+'/page/' + index, {  ajax: true, sort_order : sort_order, category:categories, brand:brands }, function(data) {
                console.log(data);
                  $('.body_blur').hide();
                if(data.status){
