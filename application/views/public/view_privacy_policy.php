            ...
            <div class="container">
                <div class="prdctarea">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="ftrd_hding">Privacy Policy</div>
                        <p> This privacy policy has been compiled to better serve those who are concerned with how their 'Personally Identifiable Information' (PII) is being used online. PII, as described in US privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website. </p>
                        <strong>
                            <h3>What personal information do we collect from the people that visit our blog, website</h3>
                        </strong>
                        ...
                        <p> We will notify the users via in-site notification<br>
                        ...
                        <p> info.anona.in    , support@anona.in and we will promptly remove you from ALL correspondence. </p>
                        <strong>
                            <h3>Contacting Us</h3>
                        </strong>
                        <p> If there are any questions regarding this privacy policy, you may contact us using the information below.<br>
                            ...
                            Anona E-mart TC 7/213,Mulamootil House Haritha Nagar, Kanjirampara.P.O Calicut-695030, Kerala	<br>
                            India
                            info.anona.in    , support@anona.in </p>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
                </div>
