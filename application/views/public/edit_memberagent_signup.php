...
<section class="top_pad20 botm_pad20">
	<div class="container tp_mar20">
		...
		<div class="col-md-offset-4 col-md-4" style="background: #f1f1f1;padding-top: 30px;    margin-bottom: 20px;">
			<div class="col-xs-12">
			    <h2 class="tp_mar20">Club Agent - Set Password</h2>
				<!--<h3>Get Started-it's Free.</h3>
				<h5>Registration take less than 2 minutes</h5>-->
			</div>
			<div class="cusmragnt">
				<form name="become_club_agent" action="<?php echo base_url(); ?>Register/signup_clubagent" method="post" id="become_club_agent">        
					...
					<div class="col-xs-12 form-group">
					<button class="button_submit3 btn_set_password"  style="margin-bottom: 28px;" type="submit">Join now</button>
					</div>
				</form>  
		    </div>
		</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.btn_set_password').click(function(e){
            ...
            $.post('<?= base_url();?>Register/signup_clubagent', data, function(data){
                if(data.status){
