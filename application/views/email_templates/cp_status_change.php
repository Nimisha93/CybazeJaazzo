    ...
    <tr>
      <td align="center" valign="top" style="padding: 0 10px;">
                          ...
                          <tbody>
                            <tr>
                              <td align="center" style="padding: 25px 0;"><p style="color: #555555; font-size: 16px; line-height: 140%; margin: 0; padding: 0;">
                                <span style="font-size: 14px;font-family:'Roboto',sans-serif;">Regards <a href="" style="text-decoration: none; color: #3392ea;" target="_blank" rel="noopener"></a> Team Jaazzo</span> </p></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; max-width: 600px;" align="center">
          <tbody>
            <tr>
              <td align="center" style="padding: 0px; text-align: center;"><p style="padding: 20px 40px 15px; margin: 0; color: #000; line-height: 22px; font-size: 14px; margin: 0; font-family: 'Open Sans',Arial, Helvetica, sans-serif;"> <a href="" style="text-decoration: none; color: #3392ea;" target="_blank" rel="noopener"></a>. </p>
              </td>
            </tr>
          </tbody>
        </table>
